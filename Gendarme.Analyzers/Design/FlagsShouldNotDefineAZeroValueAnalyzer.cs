...
public sealed class FlagsShouldNotDefineAZeroValueAnalyzer : DiagnosticAnalyzer
{
    private static readonly LocalizableString Title =
        new LocalizableResourceString(nameof(Strings.FlagsShouldNotDefineAZeroValueTitle),
            Strings.ResourceManager, typeof(Strings));

    private static readonly LocalizableString MessageFormat =
        new LocalizableResourceString(nameof(Strings.FlagsShouldNotDefineAZeroValueMessage),
            Strings.ResourceManager, typeof(Strings));

    private static readonly LocalizableString Description =
        new LocalizableResourceString(nameof(Strings.FlagsShouldNotDefineAZeroValueDescription),
            Strings.ResourceManager, typeof(Strings));
