...
public sealed class ProvideAlternativeNamesForOperatorOverloadsAnalyzer : DiagnosticAnalyzer
{
    private static readonly LocalizableString Title =
        new LocalizableResourceString(nameof(Strings.ProvideAlternativeNamesForOperatorOverloadsTitle),
            Strings.ResourceManager, typeof(Strings));

    private static readonly LocalizableString MessageFormat =
        new LocalizableResourceString(nameof(Strings.ProvideAlternativeNamesForOperatorOverloadsMessage),
            Strings.ResourceManager, typeof(Strings));

    private static readonly LocalizableString Description =
        new LocalizableResourceString(nameof(Strings.ProvideAlternativeNamesForOperatorOverloadsDescription),
            Strings.ResourceManager, typeof(Strings));
