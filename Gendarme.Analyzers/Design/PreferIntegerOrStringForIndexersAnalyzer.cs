...
public sealed class PreferIntegerOrStringForIndexersAnalyzer : DiagnosticAnalyzer
{
    private static readonly LocalizableString Title =
        new LocalizableResourceString(nameof(Strings.PreferIntegerOrStringForIndexersTitle),
            Strings.ResourceManager, typeof(Strings));

    private static readonly LocalizableString MessageFormat =
        new LocalizableResourceString(nameof(Strings.PreferIntegerOrStringForIndexersMessage),
            Strings.ResourceManager, typeof(Strings));

    private static readonly LocalizableString Description =
        new LocalizableResourceString(nameof(Strings.PreferIntegerOrStringForIndexersDescription),
            Strings.ResourceManager, typeof(Strings));
